    ...
    <div className="mx-auto max-w-lg">
      ...
      <div className="mt-6 rounded-2xl border border-line bg-surface p-6">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-full bg-primary-subtle font-display text-xl font-bold text-ink">
        ...
        <dl className="mt-6 space-y-3 border-t border-line pt-4 text-sm">
          ...
          <div className="flex justify-between">
            <dt className="text-content-secondary">Connected accounts</dt>
