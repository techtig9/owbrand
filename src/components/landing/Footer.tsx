    ...
    <footer className="border-t border-line bg-canvas py-12">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 text-center sm:flex-row sm:justify-between sm:text-left">
        <div>
          ...
          <p className="mt-1 text-xs text-ink-faint">Developed by Techtig</p>
        </div>

        <div className="flex flex-col gap-2 text-sm text-ink-soft sm:items-end">
          <a href="mailto:techtig9@gmail.com" className="flex items-center gap-2 hover:text-coral-600">
            <Mail className="h-3.5 w-3.5" /> techtig9@gmail.com
          </a>
          <a href="tel:+923488597892" className="flex items-center gap-2 hover:text-coral-600">
