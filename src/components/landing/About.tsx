...
export function About() {
  return (
    <section id="about" className="border-t border-line bg-surface-raised py-24">
      <div className="mx-auto max-w-3xl px-6 text-center reveal">
        ...
        <p className="mt-4 text-sm text-content-tertiary">owbrand is a product built and maintained by Techtig.</p>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          {LINKS.map((link) => (
            <a
              ...
              className="rounded-full border border-line bg-surface px-4 py-2 text-sm font-medium text-ink transition-colors hover:border-primary hover:text-primary"
            >
              {link.label}
            </a>
          ))}
